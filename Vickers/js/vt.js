...
function magic()
{
	...
	if(simsubscreennum==6)
	{
		...
		{
			elmt.innerHTML = "Move the mouse on the<br/> knob to measure Indentation</br> diagonal length";
			document.getElementById('6-5').style.left="-20px";
			moveKnobinXHover();
		}
...
function moveWheelonClick()
{
	...
	$('#2-3').click(function()
	{
		...
		var position = $(element).offset();  //builtin function to find the HTML element's position 
		document.getElementById('p2-2').innerHTML=document.getElementById('2-4').style.lrft;
		if(flag==1)
			var image=document.getElementById('2-2a');
		if(flag==2)
			var image=document.getElementById('2-2b');
