...
function setup() {
    ...
    magFac = new DynamicGraph(125, 430, 230, 290, "Apsolutna prenosivost", "ψ", 0, 2.5, 0, 7.5, System.mag_func);
    //phaseAng = new DynamicGraph(125, 495, 150, 290, "Phase Angle", "n", 0, 2.5, 0, 180, System.phase_func);
    relTrans = new DynamicGraph(125, 460, 220, 290, "Relative Transmissibility", "ψ", 0, 2.5, 0, 7.5, System.rel_trans);
