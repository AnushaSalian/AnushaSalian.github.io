 ...
 var looper2;
    ...
    function rotateAnimation4(el, speed, rhn){
		...
		if(degrees4 >= rhn*3.6)
		{
			...
			setTimeout(function(){
				if(repeat==1)
					document.getElementById("status").innerHTML = "Rockwell Hardness number = "+parseInt(degrees4/3.6);
				if(repeat==2)
					document.getElementById("status2").innerHTML = "Rockwell Hardness number = "+parseInt(degrees4/3.6);
				setTimeout(function(){
    ...
    function rotateAnimation5(el, speed, rhn){
		...
		if(degrees5 >= rhn*3.6)
		{
			...
			setTimeout(function(){
				if(repeat==1)
					document.getElementById("status").innerHTML = "Rockwell Hardness number = "+parseInt(degrees5/3.6);
				if(repeat==2)
					document.getElementById("status2").innerHTML = "Rockwell Hardness number = "+parseInt(degrees5/3.6);
				setTimeout(function(){
					document.getElementById("nextButton").style.visibility="visible";
				},500);
			},3000);
...
function magic()
{
	...
	{ 
		...
		if(flag==1)
		{
			...
			if(repeat==1)
			{
			    document.getElementById('4').innerHTML=ci1-1;
			}
			else if(repeat==2)
			{
				document.getElementById('4').innerHTML=ci2-1;
			}
		}
		if(flag==2)
		{
			...
			if(repeat==1)
			{
			    document.getElementById('4').innerHTML=ms1-1;
			}
			else if(repeat==2)
			{
				document.getElementById('4').innerHTML=ms2-1;
			}
		}
		if(flag==3)
		{
			...
			if(repeat==1)
			{
			    document.getElementById('4').innerHTML=br1-1;
			}
			else if(repeat==2)
			{
				document.getElementById('4').innerHTML=br2-1;
			}
		}
		if(flag==4)
		{
			...
			if(repeat==1)
			{
			    document.getElementById('4').innerHTML=al1-1;
			}
			else if(repeat==2)
			{
				document.getElementById('4').innerHTML=al2-1;
			}
		}
		if(flag==5)
		{
			...
			if(repeat==1)
			{
			    document.getElementById('4').innerHTML=ss1-1;
			}
			else if(repeat==2)
			{
				document.getElementById('4').innerHTML=ss2-1;
			}
		}
